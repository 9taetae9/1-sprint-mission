...
public class BasicChannelService implements ChannelService {
  ...
  public ChannelDto create(PrivateChannelCreateRequest request) {
    log.info("Processing private channel creation: number of participants={}",
    ...
    log.info("Private channel created successfully: channelId={}, number of participants={}",
  ...
  public ChannelDto update(UUID channelId, PublicChannelUpdateRequest request) {
    ...
    try {
      ...
      if (channel.getType().equals(ChannelType.PRIVATE)) {
        ...
        throw ChannelExceptions.privateChannelUpdate(channelId);
      }
      ...
      log.error("Error occurred during channel update: channelId={}, error={}", channelId,
          e.getMessage(), e);
      throw e;
    }
  }
  ...
  public void delete(UUID channelId) {
    ...
    if (!channelRepository.existsById(channelId)) {
      ...
      throw ChannelExceptions.notFound(channelId);
    }
    ...
    try {
      ...
      log.error("Error occurred during channel deletion: channelId={}, error={}", channelId,
          e.getMessage(), e);
      throw e;
    }
  }
