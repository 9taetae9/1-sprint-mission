...
public class ChannelController implements ChannelApi {
    ...
    public ResponseEntity<ChannelDto> create(@RequestBody PublicChannelCreateRequest request) {
        ...
        log.info("Completed public channel creation: channelId={}, name={}", createdChannel.id(), createdChannel.name());
    ...
    public ResponseEntity<ChannelDto> create(@RequestBody PrivateChannelCreateRequest request) {
        log.info("Starting private channel creation: number of participants={}", request.participantIds().size());
    ...
    public ResponseEntity<ChannelDto> update(@PathVariable("channelId") UUID channelId,
        ...
        log.info("Starting public channel update: channelId={}, newName={}", channelId, request.newName());
